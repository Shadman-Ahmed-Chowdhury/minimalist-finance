...
<x-dialog wire:model="showModal">
    ...
    <x-dialog.open>
        <div class="p-4">
            <button type="button" class="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-primary-600 rounded-lg shadow-sm transition-colors duration-200">
